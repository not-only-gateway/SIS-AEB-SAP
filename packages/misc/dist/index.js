...
function Filters(props) {
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    if (filter.value !== null) return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      className: styles$7.filterContainer,
      style: {
        display: props.changed ? 'none' : 'flex'
      }
    }, /*#__PURE__*/React__default['default'].createElement("span", {
      className: styles$7.overflowEllipsis,
      style: {
        color: '#262626',
        maxWidth: '78%'
      }
...
var css_248z$7 = ".Search-module_rowContainer__16M_B {\n  display: flex;\n\n  width: 100%;\n\n  justify-content: space-around;\n  align-items: center;\n  border-radius: 8px;\n\n  background: #f4f5fa;\n  margin-left: auto;\n\n}\n\n.Search-module_displayInlineCenter__1oW_E {\n  display: flex;\n  justify-content: center;\n  justify-items: center;\n  align-items: center;\n}\n";
var styles$6 = {"rowContainer":"Search-module_rowContainer__16M_B","displayInlineCenter":"Search-module_displayInlineCenter__1oW_E"};
...
function SearchBox(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: styles$6.rowContainer,
    style: {
    ...
    className: styles$6.displayInlineCenter
...
function Canvas(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: styles$5.zoomContainer
  }, /*#__PURE__*/React__default['default'].createElement("span", {
    className: styles$5.zoomLevelContainer
...
var css_248z$5 = ".Tab-module_tabsContainer__18VKu {\n\n    height: 60px;\n    width: fit-content;\n\n    margin: auto;\n\n    border-bottom: #e0e0e0 1px solid;\n\n    display: flex;\n    align-items: flex-end;\n    gap: 16px;\n    justify-content: center;\n\n    background: white;\n    transition: 300ms ease-in-out;\n}\n\n\n.Tab-module_tabButtonContainer__2HC5B {\n    cursor: pointer;\n\n    font-family: 'Roboto' !important;\n    outline: none;\n\n    transition: 300ms ease-in-out;\n\n    box-shadow: none;\n    padding: 12px;\n    text-align: center;\n\n    border-top-left-radius: 8px;\n    border-top-right-radius: 8px;\n\n    border: none;\n    background: transparent;\n}\n.Tab-module_tabButtonContainer__2HC5B:hover{\n    background: #E8F0FE;\n\n}";
var styles$4 = {"tabsContainer":"Tab-module_tabsContainer__18VKu","tabButtonContainer":"Tab-module_tabButtonContainer__2HC5B"};
...
function Tabs(props) {
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: styles$4.tabsContainer
    ...
    return button !== null ? /*#__PURE__*/React__default['default'].createElement("button", {
      ...
      className: [styles$4.tabButtonContainer, animations.fadeIn].join(' '),
      style: {
...
var styles$3 = {"rowContainer":"List-module_rowContainer__19RRd","fadeIn":"List-module_fadeIn__fy89i","fadeOutAnimation":"List-module_fadeOutAnimation__2W-VR","fadeOut":"List-module_fadeOut__-Ptse"};
styleInject(css_248z$3);

function ListContent(props) {
  return /*#__PURE__*/React__default['default'].createElement("button", {
    className: [styles$3.rowContainer, styles$3.fadeIn].join(' '),
    onClick: function onClick() {
      props.setEntity();
      props.clickEvent();
    },
  ...
  }), props.create ? props.lang.create : props.renderElement(props.entity));
}
...
List.propTypes = {
  ...
  clickEvent: PropTypes__default['default'].func,
  searchInput: PropTypes__default['default'].string,
  notSearched: PropTypes__default['default'].bool,
  setNotSearched: PropTypes__default['default'].func,
  fetchUrl: PropTypes__default['default'].string,
  fetchToken: PropTypes__default['default'].string,
  scrollableElement: PropTypes__default['default'].string,
  renderElement: PropTypes__default['default'].func
};

var css_248z$1 = "\n.Modal-module_modalContainer__2eFFJ {\n    width: 100%;\n    height: 100%;\n}\n\n.Modal-module_fadeIn__9fp9k {\n    position: relative;\n    animation: Modal-module_fadeIn__9fp9k ease-in-out 250ms forwards;\n\n}\n\n.Modal-module_fadeOutAnimation__L5iMu {\n    position: relative;\n    animation: Modal-module_fadeOut__1XgvO ease-in-out 250ms forwards;\n\n}\n\n\n@keyframes Modal-module_fadeOut__1XgvO {\n\n    0% {\n        opacity: 1;\n        height: inherit;\n    }\n    50% {\n        opacity: .5;\n        height: inherit;\n    }\n    90% {\n        opacity: .1;\n        height: inherit;\n    }\n    100% {\n        opacity: 0;\n        display: none;\n        height: 0;\n        z-index: -1;\n    }\n}\n@keyframes Modal-module_fadeIn__9fp9k {\n    from {\n        opacity: 0;\n    }\n    to {\n        opacity: 1;\n    }\n\n}\n";
var styles$1 = {"modalContainer":"Modal-module_modalContainer__2eFFJ","fadeIn":"Modal-module_fadeIn__9fp9k","fadeOutAnimation":"Modal-module_fadeOutAnimation__L5iMu","fadeOut":"Modal-module_fadeOut__1XgvO"};
...
function Modal(props) {
  ...
  React.useEffect(function () {
    var element = document.getElementById('modal-frame');

    if (isInRender && !props.open) {
      setStyle(styles$1.fadeOutAnimation);
    } else if (!isInRender && props.open) {
      setIsInRender(true);
      setStyle(styles$1.fadeIn);
    }
    ...
    if (element !== null && props.open) element.addEventListener('mousedown', function (event) {
      if (!event.target.contains(event.relatedTarget)) props.handleClose(false);
    });
  });
  if (isInRender) return /*#__PURE__*/React__default['default'].createElement("div", {
    id: 'modal-frame',
    ...
    id: 'modal-content'
  }, props.children));else return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null);
}
Modal.propTypes = {
...
var css_248z = ".Alert-module_alertContainer__1JyY1 {\n  padding: 8px;\n  width: clamp(500px, 500px, 90%);\n\n  position: fixed;\n  bottom: clamp(16px, 5%, 5%);\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: 25;\n\n  border-radius: 8px;\n\n  box-shadow: rgba(100, 100, 111, 0.2) 0 7px 29px 0;\n\n}\n\n.Alert-module_alertContent__BoLBu {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.Alert-module_buttonContainer__3zAD5 {\n  width: 100%;\n  border-radius: 8px;\n  box-shadow: none;\n  padding: 8px;\n  height: auto;\n  font-family: 'Roboto' !important;\n  outline: none;\n  border: none;\n  transition: 200ms ease-in-out;\n  cursor: pointer;\n  display: flex;\n  justify-content: flex-start;\n}\n\n\n.Alert-module_fadeIn__2MOzD {\n  position: relative;\n  animation: Alert-module_fadeIn__2MOzD ease-in-out 150ms forwards;\n}\n";
var styles = {"alertContainer":"Alert-module_alertContainer__1JyY1","alertContent":"Alert-module_alertContent__BoLBu","buttonContainer":"Alert-module_buttonContainer__3zAD5","fadeIn":"Alert-module_fadeIn__2MOzD"};
styleInject(css_248z);

function Alert(props) {
  var _useState = React.useState(undefined),
      _useState2 = _slicedToArray(_useState, 2),
      alertColor = _useState2[0],
      setAlertColor = _useState2[1];
  ...
  return /*#__PURE__*/React__default['default'].createElement(Modal, {
    ...
    children: /*#__PURE__*/React__default['default'].createElement("div", {
      className: [styles.alertContainer, styles.fadeIn, styles.alertContent].join(' '),
      style: alertColor
    ...
    }, props.message), /*#__PURE__*/React__default['default'].createElement("button", {
      className: styles.buttonContainer,
      onClick: function onClick() {
        return props.handleClose();
      },
    ...
    }, /*#__PURE__*/React__default['default'].createElement(icons.CloseRounded, null))),
    styles: {
      display: 'grid',
