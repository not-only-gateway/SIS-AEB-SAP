        ...
        <div className={shared.pageWrapper}>
            ...
            <Breadcrumbs justify={'start'}>
                ...
                <Button variant={"minimal"}
                        onClick={() => props.redirect('/?page=project&id=' + operation.work_plan?.activity_project.id)}
                ...
                <Button variant={"minimal"}
                        onClick={() => props.redirect('/?page=ted&id=' + operation.work_plan?.ted.id)}
                        className={shared.button}>
                ...
                <Button variant={"minimal"}
                        onClick={() => props.redirect('/?page=wp&id=' + operation.work_plan?.id)}
                        className={shared.button}>
                ...
                <Button variant={"minimal"}
                        onClick={() => props.redirect('/?page=wp&tab=4&id=' + operation.work_plan?.id)}
                        className={shared.button}>
                ...
                <Button variant={"minimal"}
                        onClick={() => props.redirect('/?page=wp&tab=5&id=' + operation.work_plan?.id)}
                        className={shared.button}>
