...
import {CloseRounded, DeleteForeverRounded, RemoveRounded} from "@material-ui/icons";
                ...
                <div className={styles.modalContainer} id={'selector-modal'}>
                    ...
                    <div style={{display: 'grid', gap: '8px'}}>
                        ...
                        <List
                            ...
                            renderElement={entity => entity !== props.selected ? props.renderEntity(entity) : null}
                            searchInput={search}
                            clickEvent={() => null}
                            createOption={false} listKey={'selector-list'}
